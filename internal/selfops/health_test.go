...
func TestEvaluateBoundaries(t *testing.T) {
	...
	cases := []struct {
		...
		{
			"fixed_order",
			Signals{DiskFreePct: 5, RoutingMisses: 3, OutcomesTotal: 3, Salvaged: 2, HoldsPending: 4},
			[]string{"disk space low", "WakeUser routing misses", "salvage rate elevated", "holds backlog"},
		},
	}
